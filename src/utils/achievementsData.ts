export type AchievementCode = 
    ...
    | 'WEEKEND_WARRIOR' | 'OVERACHIEVER' | 'EARLY_BIRD' | 'LUCKY_DROP'
    | 'FALSE_ALARM' | 'TWINNING';
...
export const ACHIEVEMENTS: Record<AchievementCode, AchievementMeta> = {
    ...
    TWINNING: { code: 'TWINNING', title: 'Twinning', description: 'You and your partner logged the exact same number of poops today.', icon: '👯‍♂️', color: '#00FFFF', type: 'meta' },
